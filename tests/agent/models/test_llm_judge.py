"""Test suite for the judge LLM factory.
...
from agent.models.llm_judge import JUDGE_MODEL_NAME, get_judge_llm


@patch("agent.models.llm_judge.settings")
@patch("agent.models.llm_judge.ChatGroq")
def test_get_judge_llm_default_temperature(mock_chat_groq_class, mock_settings) -> None:
    """Verify get_judge_llm defaults to temperature=0.0."""
...
@patch("agent.models.llm_judge.settings")
@patch("agent.models.llm_judge.ChatGroq")
def test_get_judge_llm_explicit_temperature(
    ...
    result = get_judge_llm(temperature=0.5)
