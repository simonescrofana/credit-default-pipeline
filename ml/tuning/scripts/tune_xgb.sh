...
# path):
#   ./ml/tuning/scripts/tune_xgb.sh
# (make it executable once with: chmod +x ml/tuning/scripts/tune_xgb.sh)

set -euo pipefail

FILE="ml/models/xgboost_model.py"
RUNNER_FILE="ml/run_training.py"
RESULTS="ml/tuning/results/xgboost_results.csv"
LOG_DIR="ml/tuning/logs/xgboost"
